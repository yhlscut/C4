...
def main():
    ...
    network = Network1Stage().to(device)
    network.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pth_path0", type=str, default="trained_models/c4_sq_1stage/fold0.pth")
    parser.add_argument("--pth_path1", type=str, default="trained_models/c4_sq_1stage/fold1.pth")
    parser.add_argument("--pth_path2", type=str, default="trained_models/c4_sq_1stage/fold2.pth")
